...
public class OptionScreen extends MenuScreen {
	...
	private String filePath = "TYPdcuZ.png";
	...
	@Override
	public void show() {
		menu = new TextureRegion(new Texture(Gdx.files.internal(filePath)), 0, 0, m_Projection_Matrix_Width, m_Projection_Matrix_Height);//m_Screen_Width, m_Screen_Height);
		batch = new SpriteBatch();
